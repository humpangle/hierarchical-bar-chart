// https://observablehq.com/@d3/hierarchical-bar-chart@321
...
Click a blue bar to drill down, or click the background to go back up.`;
  ...
  main
    ...
    .define(
      "chart",
      ["d3", "width", "height", "x", "root", "up", "xAxis", "yAxis", "down"],
  ...
  main
    .variable(observer("bar"))
    .define("bar", ["margin", "barStep", "barPadding", "x"], function(
      margin,
      barStep,
      barPadding,
      x
  ...
  main
    .variable(observer("stack"))
    .define("stack", ["x", "barStep"], function(x, barStep) {
  ...
  main
    .variable(observer("stagger"))
    .define("stagger", ["x", "barStep"], function(x, barStep) {
  ...
  main
    .variable(observer("root"))
    .define("root", ["d3", "data"], function(d3, data) {
      return d3
        .hierarchy(data)
        .sum(d => d.value)
  ...
  main
    ...
    .define("xAxis", ["margin", "d3", "x", "width"], function(
      margin,
      d3,
      x,
      width
  ...
  main
    ...
    .define("yAxis", ["margin", "height"], function(margin, height) {
      return g =>
        g
          .attr("class", "y-axis")
  ...
  main
    .variable(observer("barPadding"))
    .define("barPadding", ["barStep"], function(barStep) {
      return 3 / barStep;
    });
  ...
  main
    ...
    .define("height", ["root", "barStep", "margin"], function(
      root,
      barStep,
      margin
    ) {
  ...
  main.variable(observer("margin")).define("margin", function() {
    return { top: 30, right: 30, bottom: 0, left: 100 };
  });
